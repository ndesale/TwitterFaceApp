...
function share() {
		...
		$.post("Tweet", post_data, function(data) {
			...
			var url = "https://www.facebook.com/dialog/send?app_id=415036812758045";
		    url = url + "&link=" + share_url;
		    url = url + "&redirect_uri=https://apps.facebook.com/415036812758045/?fb_source=feed";
		    window.open(url);
	} );
		...
		<div class="row">
			<div class="span4 offset4">
				...
				var post = function() {
					...
					var url = "https://www.facebook.com/dialog/share?app_id=415036812758045&href=https://project1-test-260621.appspot.com/"
			        url = url + "&quote=" + text;
					window.open(url);
				}
				</script>
