...
public static Iterable<Entity> listEntities(String kind, String searchBy,
  	...
  	if (searchFor != null && !"".equals(searchFor)) {
  	 // q.setFilter(searchBy, FilterOperator.EQUAL, searchFor);
  	  
  	Filter propertyFilter = new FilterPredicate(searchBy, FilterOperator.EQUAL, searchFor);
...
public static Iterable<Entity> listChildren(String kind, Key ancestor) {
  	...
  	Filter propertyFilter = new FilterPredicate(Entity.KEY_RESERVED_PROPERTY, FilterOperator.GREATER_THAN, ancestor);
	q.setFilter(propertyFilter);
